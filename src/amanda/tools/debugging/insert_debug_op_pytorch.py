...
static auto registry = torch::RegisterOperators(
  ...
  torch::RegisterOperators::options().aliasAnalysis(
    torch::AliasAnalysisKind::CONSERVATIVE)
  );
"""
