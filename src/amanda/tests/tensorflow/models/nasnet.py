...
build_nasnet_cifar.default_image_size = 32  # type: ignore


def build_nasnet_mobile(images, num_classes, is_training=True, final_endpoint=None):
...
build_nasnet_mobile.default_image_size = 224  # type: ignore


def build_nasnet_large(images, num_classes, is_training=True, final_endpoint=None):
...
build_nasnet_large.default_image_size = 331  # type: ignore
