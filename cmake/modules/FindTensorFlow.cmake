...
if(TensorFlow_FOUND AND EXISTS "${TensorFlow_LIBRARY}" AND IS_DIRECTORY "${TensorFlow_INCLUDE_DIR}")
  ...
  if(TF_FIND_VERSION_EXACT)
    ...
    set(_TensorFlow_KNOWN_VERSIONS ${TensorFlow_ADDITIONAL_VERSIONS}
        "1.9" "1.9.0" "1.10" "1.10.0" "1.11" "1.11.0" "1.12" "1.12.0" "1.13" "1.13.1" "1.13.2"
        "1.14" "1.14.0" "1.15" "1.15.0" "1.15.2" "1.15.3" "1.15.4" "1.15.5")
    set(_TensorFlow_TEST_VERSIONS)
...
macro(add_tensorflow_cpu_operation op_name)
  ...
  add_library(${op_name}_op SHARED tensorflow/kernels/${op_name}_op.cc tensorflow/kernels/${op_name}_kernel.cc tensorflow/ops/${op_name}.cc )
...
# Compiles a CPU + GPU operation with invoking NVCC
  ...
  if(EXISTS "kernels/${op_name}_kernel.cu")
     ...
     set(kernel_file tensorflow/kernels/${op_name}_kernel.cu)
  else()
    set_source_files_properties(tensorflow/kernels/${op_name}_kernel_gpu.cu.cc PROPERTIES CUDA_SOURCE_PROPERTY_FORMAT OBJ)
     set(kernel_file tensorflow/kernels/${op_name}_kernel_gpu.cu.cc)
  endif()
